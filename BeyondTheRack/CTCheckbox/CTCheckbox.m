...
- (void)setUp
{
    ...
    self.checkboxColor = [UIColor darkGrayColor];
...
- (void)layoutSubviews
{
    ...
    if ([[[UIDevice currentDevice] systemVersion] compare:@"7.0" options:NSNumericSearch] != NSOrderedAscending) {
        ...
        CGRect r = [self.textLabel.text boundingRectWithSize:textLabelMaxSize options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName: self.textLabel.font} context:nil];

        textLabelSize = r.size;
    }
